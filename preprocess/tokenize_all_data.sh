...
TOKENIZER=/shared_silo/scratch/mika/models/Qwen3.5-4B-Base #set you tokenizer and below also

DATASET_DIR=/shared_silo/scratch/datasets/english/wikipedia #you path to jsonl files, if muttiple will tokenize all
TOKENIZED_DIR=/shared_silo/scratch/datasets/tokenized  #set your path megatron tokenized
