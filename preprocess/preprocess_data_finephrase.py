# modified version of Megatron-LM/tools/preprocess_data.py, to get the rollouts
...
class Encoder(object):
    ...
    def split(self, json_line):
        ...
        for key in self.args.json_keys:
            #text = data[key]
            if self.args.rollout_key:
                text = data[self.args.rollout_key][0][key]
            else:
                text = data[key]            
            if text!="":
                max_len = 1000000
...
def get_args():
    ...
    group.add_argument('--rollout-key', type=str, default=None,
                       help='If set, extract text as data[rollout_key][0][json_key]. '
                             'Use "rollout_results" for FinePhrase.')                            
