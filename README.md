...
using eos_token <|endoftext|>

#### Standard 

download_and_tokenize/preprocess/tokenize_all_data.sh

-Define the folder and other parameters in the file, processes all files in the whole folder.

Processes also chat data with template <|im_start|> <|im_end|>
